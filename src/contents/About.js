...
class About extends Component {
    render() {
        return (
            ...
            <h2 className="abouthead">Silas <mark className="mark2">Silikhe</mark></h2>
            <p>Full Stack Developer</p>
            <br></br>
            <p className="p10">I started my journey in the world of computers from an young age,
            now I’m 21 years old, Pursuing my Operations Research Degree in
            JKUAT.  Android developmement and Designing are  my center of interest, i always
            ...
            to the world through Github and pintrest.
            </p>
            <div className="Edu">
            ...
            <h4>B.sc Operations Research</h4>
            <p className="p1">JKUAT</p>
            <p className="p1"><i class="fa fa-calendar i2"></i>May 2000 - 2000</p>
            <h4>High School</h4>
            <p className="p1">Lorem ipsum high school</p>
            ...
            <div class="sk s6 glass">Yii2/PHP</div>
            </div>
            )
        }
    }
